...
from repositories.iterableobject import IterableObject
...
class StudentRepository:
    def __init__(self, StudentList=None):
        if StudentList is None:
            self._StudentList = IterableObject()
        else:
            self._StudentList = IterableObject(StudentList)
...
class DisciplineRepository:
    def __init__(self, DisciplineList=None):
        if DisciplineList is None:
            self._DisciplineList = IterableObject()
        else:
            self._DisciplineList = IterableObject(DisciplineList)
...
class GradeRepository:
    def __init__(self, GradeList=None):
        if GradeList is None:
            self._GradeList = IterableObject()
        else:
            self._GradeList = IterableObject(GradeList)
...
class StatisticRepository:
    def __init__(self):
        self._StatisticList = IterableObject()
