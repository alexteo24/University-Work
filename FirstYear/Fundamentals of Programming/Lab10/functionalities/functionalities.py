...
from repositories.iterableobject import SortAndFilter
...
class ServiceGrades:
    ...
    def search_grade_student_id(self, student_id):
        ...
        """
        search_result = []
        for a_grade in self._grade_repository.list:
...
class ServiceStatistic:
    def __init__(self, statistic_repository, student_repository, discipline_repository, grade_repository, grade_service):
    ...
    def calculate_student_average_grade_discipline(self, student_id, discipline_id):
        ...
        :return: The average grade of the student or 0 if the student has no grades at the discipline having the
            id = discipline_id
        """
        search_result = self._grade_service.search_grade_student_id(student_id)
        index = 0
    ...
    def create_best_students_statistic(self):
        ...
        self._sort_and_filter.sort(self._statistic_repository.list, function=lambda student1, student2: student1['average_grade'] < student2['average_grade'])
        self._sort_and_filter.filter(self._statistic_repository.list,
                                     function=lambda student: student['average_grade'] != 0)
    ...
    def create_best_disciplines_statistic(self):
        ...
        self._sort_and_filter.sort(self._statistic_repository.list, function=lambda discipline1, discipline2: discipline1['average_grade'] < discipline2['average_grade'])
        self._sort_and_filter.filter(self._statistic_repository.list,
                                     function=lambda discipline: discipline['average_grade'] != 0)
