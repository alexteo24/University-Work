...
def list_ui(student_or_discipline_or_grade_repository):
    ...
    :return:
    """
    for student_or_discipline_or_grade in student_or_discipline_or_grade_repository:
        ...
        while not are_we_done_yet:
            try:
                ...
                if user_command == '0':
                    ...
                    list_ui(self._ServiceStudent.repo.list)
                elif user_command == "4.2":
                    list_ui(self._ServiceDiscipline.repo.list)
                elif user_command == "4.3":
                    list_ui(self._ServiceGrade.repo.list)
