...
std::string Coat::toString() {
    std::string result = _size + ", " + _color + ", " + std::to_string(_price) + ", " + std::to_string(_quantity) + ", "
                                       + _uniqueID + ", " + _photographLink;
    return result;
}

void Coat::setColor(const std::string &color) {
    _color = color;
}

void Coat::setPhotographLink(const std::string &photographLink) {
    _photographLink = photographLink;
}
...
void Coat::setSize(const std::string &size) {
    _size = size;
}
